...
public class SendEmail {
	...
	private String from = "tomtiantao@126.com"; // 发件人邮箱地址
	private String user = "tomtiantao@126.com"; // 发件人称号，同邮箱地址
	private String password = "tiantao964"; // 发件人邮箱客户端授权码
	...
	public static void main(String[] args) { // 做测试用
		...
		boolean flag = ds.sendMail("964765920@qq.com", "田涛你好！你在《大圣项目》中，问题：登录异常，还未修复，请及时修复！", "代码评审未修复通知");
